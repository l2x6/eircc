 ...
 */
public class JoinIrcChannelAction extends AbstractTreeAction {

    public JoinIrcChannelAction(Tree tree) {
        super(tree);
        setText(IrcUiMessages.JoinIrcChannelAction_label);
        setImageDescriptor(IrcImages.getInstance().getImageDescriptor(ImageKey.CONNECT));
    }
