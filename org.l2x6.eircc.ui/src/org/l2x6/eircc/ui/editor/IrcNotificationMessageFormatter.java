 ...
 */
public class IrcNotificationMessageFormatter extends IrcDefaultMessageFormatter {

    /**
     * @param preferences
     */
    public IrcNotificationMessageFormatter(IrcPreferences preferences) {
        super(preferences);
    }
    ...
    public void format(StyledWrapper target, PlainIrcMessage message, TimeStyle timeStyle) {
        ...
        target.append(message.getText(), preferences.getNotificationMessageStyle());
    }
}
