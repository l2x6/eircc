...
public class IrcChannelsSelector extends SelectionAdapter implements DisposeListener {
    ...
    public String[] getChannelNames() {
        ...
        StringTokenizer tokenizer= new StringTokenizer(fTextField.getText(), CHANNEL_NAME_DELIMITER);
    ...
    protected void handleBrowseButton() {
        TypeFilteringDialog dialog= new TypeFilteringDialog(fTextField.getShell(), Arrays.asList(getChannelNames()));
